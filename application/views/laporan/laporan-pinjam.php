...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <a href="<?= base_url('laporan/cetak_laporan_pdf/pinjam'); ?>" target="_blank" class="btn btn-warning mb-3"><i class="far fa-file-pdf"></i> Download Pdf</a>
            <a href="<?= base_url('laporan/export_excel/pinjam'); ?>" target="_blank" class="btn btn-success mb-3"><i class="far fa-file-excel"></i> Export ke Excel</a>
